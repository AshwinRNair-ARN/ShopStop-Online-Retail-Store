...
CREATE TABLE `subscription` (
  ...
  `Price` int NOT NULL,
  PRIMARY KEY (`S_ID`),
  CONSTRAINT `subscription_chk_1` CHECK (((`Benefit` > 0) and (`Benefit` < 10))),
  CONSTRAINT `subscription_chk_2` CHECK ((`Price` > 0))
...
INSERT INTO `subscription` VALUES (1,'3 Months',3,300),(2,'6 Months',5,600),(3,'12 Months',8,1200);
